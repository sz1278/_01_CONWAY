...
//       var p0 = img[whichimage].get(i-1, j-1)[0]>threshold; 
//       var p1 = img[whichimage].get(i, j-1)[0]>threshold; 
//       var p2 = img[whichimage].get(i+1, j-1)[0]>threshold; 
//       var p3 = img[whichimage].get(i-1, j)[0]>threshold; 
//       var p4 = img[whichimage].get(i, j)[0]>threshold; 
//       var p5 = img[whichimage].get(i+1, j)[0]>threshold; 
//       var p6 = img[whichimage].get(i-1, j+1)[0]>threshold; 
//       var p7 = img[whichimage].get(i, j+1)[0]>threshold; 
//       var p8 = img[whichimage].get(i+1, j+1)[0]>threshold; 
...
function draw() {
  ...
  for (var i = 0; i < howwide; i++) {
    for (var j = 0; j < howtall; j++) {
      ...
      var p5 = img[whichimage].get(i+1, j-1)[0]>threshold; // right
...
function randomize()
{
  var randthresh = 9; // 80% of pixels will be dead.
  img[whichimage].loadPixels(); // load pixels into memory
  img[1-whichimage].loadPixels(); // load pixels into memory
  for (var i = 0; i < img[whichimage].width; i++) {
    for (var j = 0; j < img[whichimage].height; j++) {
